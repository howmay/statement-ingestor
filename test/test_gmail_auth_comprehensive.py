...
def test_load_credentials_rejects_legacy_non_json_token_files():
    with patch("src.integrations.gmail.auth.os.path.exists", return_value=True), \
         patch("src.integrations.gmail.auth.Credentials.from_authorized_user_file") as mock_from_file, \
