...
class TestHSBCOCRComprehensive:
    ...
    def test_enrich_hsbc_candidate_selection(self, mock_langs, mock_exists, mock_get_password, mock_which, mock_ocr_rows):
    ...
    @patch('src.parsing.ocr.hsbc_ocr.os.path.exists')
    @patch('src.parsing.ocr.hsbc_ocr._get_tesseract_langs')
    def test_enrich_hsbc_matching_logic(self, mock_langs, mock_exists, mock_which, mock_ocr_rows):
